...
| 항목 | 설명 |
|------|------|
| Azure Contributor | 실습용 리소스 그룹과 Azure Container Apps 관련 리소스를 만들 수 있어야 합니다. |
...
| Fine-grained PAT 권한 | repository 범위 runner 등록과 queued Job 조회에 필요한 Fine-grained PAT를 만들 수 있어야 합니다. |
...
| 01 | [GitHub 사전 준비](docs/01-prerequisites-github.md) | Cloud Shell 변수, `Private repository`, Fine-grained PAT 준비 | 10분 |
...
|------|------|-----------|
| 시작 | 개요 및 실습 범위 확인 | 5분 |
| 1부 | GitHub 준비 + Azure 기반 리소스 준비 | 25분 |
